...
public class LocalJudgeA6Test {
    ...
    void testTree_05_levelTraverse() {
        ...
        try {
            ...
            builder.append(levelTraverse.invoke(stringTree2).toString().trim());
            builder.append(ls);
            builder.append(levelTraverse.invoke(intTree).toString().trim());
    ...
    private MyBinaryTree<Integer> getIntegerTree() throws
